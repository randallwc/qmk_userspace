...
bool  three_mods_right  = true;        // Right mods layout  (true = 3x 1u keys,  false = 2x 1.5u keys)
...
#define MA_LAYER_NAME     "    L1"      // Layer _BASE name
#define L1_LAYER_NAME     "    L2"      // Layer _VIA1 name
#define L2_LAYER_NAME     "    L3"      // Layer _VIA2 name
#define L3_LAYER_NAME     "    L4"      // Layer _VIA3 name
/*================================================================================================================*/
